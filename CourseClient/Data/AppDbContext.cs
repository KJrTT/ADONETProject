...
namespace CourseClient.Data
{
    ...
    {
        static string connectionString = "Server=(localdb)\\MSSQLLocalDB;Database=SaleCourses;Trusted_Connection=true;TrustServerCertificate=true";
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // ПРАВИЛЬНОЕ использование для SQL Server
                optionsBuilder.UseSqlServer(connectionString);

                // Для отображения SQL запросов в консоли (для отладки)
